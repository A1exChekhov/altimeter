...
- пульс, SpO₂ и шаги через HealthKit с отображением реального источника (Apple Watch,
...
Приложение читает последние разрешённые измерения и сегодняшние шаги из Apple HealthKit. Для Apple Watch
