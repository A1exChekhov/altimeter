            ...
            List {
                ...
                Section {
                    sourceRow(
                        ...
                        subtitle: "Если приложение производителя записывает показатели в Apple Health, Альтиметр прочитает доступные пульс, SpO₂, шаги и активные калории автоматически."
                    )
