            ...
            List {
                Section {
                    sourceRow(
                        ...
                        color: .pink,
                        title: "Apple Watch",
                        subtitle: "Пульс, SpO₂, шаги и активные калории читаются из Apple Health после синхронизации часов. Доступность SpO₂ зависит от модели часов и региона."
                    )
                } header: {
                ...
                Section {
                    sourceRow(
                        ...
                        subtitle: "Если приложение производителя записывает показатели в Apple Health, Altimeter Kailas прочитает доступные пульс, SpO₂, шаги и активные калории автоматически."
                    )
                ...
                Section("Конфиденциальность") {
                    Text("Altimeter Kailas только читает выбранные вами показатели. Данные не отправляются на сервер и используются локально для отображения и предупреждений о высоте.")
                        .font(.footnote)
                }
            }
